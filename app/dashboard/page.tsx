...
//       // ...existing Unsplash download logic...
//       const trackRes = await fetch(image.links.download_location, {
//         headers: {
...
//   const handleFavorite = async (image: UnsplashImage) => {
//   try {
...
//         body: JSON.stringify({ imageId: image.id }),
//       })
//       newFavorites = favorites.filter((id) => id !== image.id)
...
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({ imageId: image.id, imageData: image }),
//       })
//       newFavorites = [...favorites, image.id]
//       toast.success("Image added to your favorites.")
//     }
//     setFavorites(newFavorites)
//     // Optionally update localStorage for fast UI, but backend is now source of truth
