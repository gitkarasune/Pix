          ...
          <div className="relative py-24 lg:py-28">
            <div className="mx-auto max-w-7xl px-6 md:px-12">
              <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
                <Link
                  href="/dashboard"
                  className="rounded-full mx-auto flex w-fit items-center gap-2 border bg-muted/50 p-1 pr-3 hover:bg-muted/80 transition-colors">

                  <span className="bg-muted rounded-[calc(var(--radius)-0.25rem)] px-2 py-1 text-xs">New</span>
                 
                  <span className="text-sm">AI-Powered Image Discovery</span>
                  <span className="bg-(--color-border) block h-4 w-px"></span>

                  <ArrowRight className="size-4" />
                </Link>

                <h1 className="mt-8 text-4xl font-bold md:text-6xl xl:text-7xl xl:[line-height:1.125]">
                  Discover Stunning Images <br />
                  <span className="">
                    Powered by AI
                  </span>
                </h1>

                <p className="mx-auto mt-8 hidden text-muted-foreground max-w-2xl text-wrap text-lg sm:block">Search,
                  discover, and download the perfect visuals for your projects.</p>
                <p className="mx-auto mt-6 max-w-2xl text-wrap sm:hidden">Explore millions of high-quality images from Unsplash with intelligent AI assistance. Search,
                  discover, and download the perfect visuals for your projects.</p>
              ...
              <div className="x-auto relative mx-auto mt-8 max-w-4xl sm:mt-12">
